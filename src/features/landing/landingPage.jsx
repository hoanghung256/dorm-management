...
const LandingPage = () => {
    ...
    return (
        <>
                ...
                <main>
                    <section id="home" className="homepage-hero">
                        <div className="homepage-content">
                            ...
                            <p>
                                DMS mang đến trải nghiệm quản lý phòng trọ hoàn toàn mới với công nghệ AI, giúp tối ưu
                                hóa chi phí, tăng cường giao tiếp và xây dựng cộng đồng sinh viên văn minh.
                            </p>
                            <div className="homepage-cta">
                                ...
                                <a href="#" onClick={openPricing} className="homepage-button-secondary">
                                    Xem tính năng
                                </a>
                        ...
                        <div className="contact-container">
                            <div className="contact-content">
                                <div className="contact-form-wrapper">
                                    <h2>Liên hệ</h2>
                                    <p>
                                        Bạn có thắc mắc, phản hồi hoặc cần hỗ trợ? Chúng tôi luôn sẵn sàng giúp bạn! Hãy
                                        liên hệ với nhóm của chúng tôi bất cứ lúc nào, chúng tôi rất muốn lắng nghe bạn.
                                    </p>
            ...
            <PricingPopup mt={10} isOpen={isPricingOpen} onClose={() => setIsPricingOpen(false)} />
        </>
    );
};
