  ...
  const challengesSolutions = [
     {
      challenge: {
        ...
        description: "Người thuê dễ quên hạn hợp đồng hoặc đóng tiền trọ muộn, gây rắc rối cho cả quản lý và người ở."
      },
      solution: {
      title: "Tự động nhắc nhở",
      description: "Hệ thống gửi thông báo qua email, SMS hoặc app khi sắp đến hạn hợp đồng hoặc hạn nộp tiền."
    }
    },
    {
      challenge: {
        title: "Quản lý thủ công bằng giấy tờ / Excel",
        description: "Chia sẻ tiền điện, nước, internet giữa các bạn cùng phòng thường gây tranh cãi và không minh bạch."
      },
      solution: {
        title: "Quản lý tài chính và công nợ thiếu minh bạch",
        description: "Tự động tính toán và phân chia chi phí theo tỷ lệ công bằng, minh bạch 100%. Theo dõi chi tiêu và tạo báo cáo chi tiết."
      }
    },
    {
      challenge: {
      ...
      solution: {
        ...
        description: "Thông báo push và hệ thống nhắc nhở tự động giúp mọi người luôn cập nhật thông tin quan trọng."
      }
    },
    ...
    <div className="homepage-container">
      <section id="home" className="homepage-hero">
        <div className="homepage-content">
          ...
          <p>
            DMS mang đến trải nghiệm quản lý phòng trọ hoàn toàn mới với công nghệ AI, 
            giúp tối ưu hóa chi phí, tăng cường giao tiếp và xây dựng cộng đồng sinh viên văn minh.
          </p>
      ...
      <section id="about" className="about-section">
         <div className="about-header">
              <h1>Đồng hành cùng <span className="highlight-text">cuộc sống</span> của bạn</h1>
            </div>
          ...
          <div className="about-content">
            ...
            <div className="about-images">
              <img src="https://cdn.home-designing.com/wp-content/uploads/2019/09/modern-nordic-dorm-style-bedroom-design.jpg" alt="Modern Dormitory" />
              <img src="https://www.roanoke.edu/images/StudentLife/Housing/ches_800w.jpg" alt="Student Living" />
              <img src="https://tse1.explicit.bing.net/th/id/OIP.EuUGCK4A9ygcC1adjEGU6gHaFj?rs=1&pid=ImgDetMain&o=7&rm=3" alt="Community Space" />
              <img src="https://www.harringtonhousing.com/uploads/0003/3066/2023/01/12/efficient-studying-methods-for-college-students.jpg" alt="Happy Students" />
            </div>
          </div>
      </section>
        ...
        <div className="contact-container">
          <div className="contact-content">
            <div className="contact-form-wrapper">
              <h2>Liên hệ</h2>
              <p>
                Bạn có thắc mắc, phản hồi hoặc cần hỗ trợ? Chúng tôi luôn sẵn sàng giúp bạn!
                Hãy liên hệ với nhóm của chúng tôi bất cứ lúc nào, chúng tôi rất muốn lắng nghe bạn.
              </p>
        ...
        <div className="footer-container">
          <div className="footer-content">
            <div className="footer-left">
              <span>© 2025 Ngu Hanh Son, Đà Nẵng</span>
            </div>
            <div className="footer-right">
              <span>📧 tubbiestech@gmail.com</span>
              <span>📱 0886059979</span>
            </div>
          </div>
        </div>
      </footer>
